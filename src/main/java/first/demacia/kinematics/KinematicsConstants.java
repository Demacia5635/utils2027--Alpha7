...
public class KinematicsConstants {
    ...
    public static final double MAX_FAST_TURN_ANGLE = MAX_RADIAL_ACCEL / MAX_LINEAR_ACCEL; //if angle is lower, no need to slow down to turn (max angle the robot can keep it's veloities while rotating)
